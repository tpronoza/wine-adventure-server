...
class Wine101View(ViewSet):
    ...
    def retrieve(self, request, pk):
        wine101 = Wine101View.objects.get(pk=pk)
        serializer = Wine101Serializer(wine101)
        return Response(serializer.data)

    def list(self, request):
        wines101 = Wine101View.objects.all()
    ...
    def create(self, request):
        ...
        wine101 = Wine101View.objects.create(
...
class Wine101Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Wine101
        fields = ('id', 'article_name', 'context', 'article_image', 'article_link', 'uid')
        depth = 1
